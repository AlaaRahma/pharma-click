...
{
	$result= $pharmacyProducts->PharmacyProducts($phramid);
}
else 
{$id=$_SESSION['id'];
$result= $pharmacyProducts->PharmacyProducts($id);
}
...
<div class="col-md-3">
					...
					<a href="single-product.php?id=<?php echo $row["drug_id"];?> &phramid= <?php echo  $row['User_id']  ; ?> ">
							...
							<p class="price"><?php echo  $row["company_name"]; ?></p>
						<p class="price"><?php echo  $row["price"]; ?></p>
						<p class="Pharmacy_name"><?php echo  $row["First_name"]; ?></p>
